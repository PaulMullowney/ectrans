...
CONTAINS
  ...
  SUBROUTINE LTDIR(ALLOCATOR,HLTDIR,ZINPS,ZINPA,ZINPS0,ZINPA0,KF_FS,KF_UV,KF_SCALARS,&
    ...
    USE ISO_C_BINDING,          ONLY: C_SIZE_T, C_F_POINTER, C_LOC, C_SIZEOF, C_INT8_T
    USE ROCTX_PROFILING,        ONLY: ROCTXRANGEPUSH, ROCTXRANGEPOP
    ...
    CALL GSTATS(412,0)
#ifdef OMPGPU
    CALL ROCTXRANGEPUSH("LTDIR End Target Data")
    !$OMP END TARGET DATA
    !$OMP END TARGET DATA
    !$OMP END TARGET DATA
    !$OMP END TARGET DATA

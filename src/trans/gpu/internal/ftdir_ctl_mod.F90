...
CALL GSTATS_TRACER(158,0)

! needed ??? JF_FS=KF_FS-D%IADJUST_D
#ifdef USE_CUDA_AWARE_MPI_FT
CALL GSTATS_TRACER(430,0)
#ifdef ACCGPU
...
CALL GSTATS_TRACER(158,1)
CALL GSTATS_TRACER(106,0)

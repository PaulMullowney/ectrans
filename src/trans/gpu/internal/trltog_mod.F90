...
!      IRECV_FLD_START = 1 !! INT(ZCOMBUFR(-1,INR),KIND=JPIM) !! is this always 1 ?
 ...
 &                  PGP,PGPUV,PGP3A,PGP3B,PGP2)
  ...
  !$OMP& SHARED(NGPBLKS,IGPTRSEND,LLPGPONLY,LLINDER,MYSETW,IFLDS,KPTRGP,INDOFF,MYPROC,IGPTROFF) &
  !$OMP& SHARED(PGP,PGLAT,INDEX,IFLDOFF,LLUV,PGPUV,IUVLEVS,IUVPARS,LLGP2,PGP2,IGP2PARS,LLGP3A) &
  !$OMP& SHARED(PGP3A,IGP3ALEVS,IGP3APARS,LLGP3B,PGP3B,IGP3BLEVS,IGP3BPARS,NOUT,INDEX,INDOFF) &
#endif
  ...
  !$OMP& SHARED(INSEND,JSEND,ISEND_FLD_START,ISENDTOT,KF_FS,ZCOMBUFS,INDEX,INDOFF,PGLAT)
    DO INS=1,INSEND
      ISEND=JSEND(INS)
  ...
  !$OMP& SHARED(INRECV,JRECV,ZCOMBUFR,KF_GP,KVSET,NGPBLKS,IGPTRSEND,LLPGPONLY,LLINDER) &
  !$OMP& SHARED(PGP,KPTRGP,LLUV,PGPUV,IUVLEVS,IUVPARS,LLGP2,PGP2,IGP2PARS,LLGP3A,PGP3A) &
  !$OMP& SHARED(IGP3ALEVS,IGP3APARS,LLGP3B,PGP3B,IGP3BLEVS,IGP3BPARS) &
  DO INR=1,INRECV
      IRECV=JRECV(INR)
      CALL PE2SET(IRECV,ISETA,ISETB,ISETW,ISETV)
      IRECVSET = ISETV

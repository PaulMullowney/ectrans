...
#define TRGTOL_DTYPE MPI_REAL8
    ...
    DO INS=1,ISEND_COUNTS
      ...
      IF(PRESENT(PGP)) THEN
        ...
        !$OMP& DEFAULT(NONE) &
#endif
        !$OMP& PRIVATE(JK,JBLK,IFLD,JI) SHARED(IFLDA,PGP) HAS_DEVICE_ADDR(ZCOMBUFS) &
        !$OMP& FIRSTPRIVATE(ISEND_FIELD_COUNT_V,ISEND_WSET_SIZE_V,NPROMA,ISEND_WSET_OFFSET_V,&
      ...
      ELSE
        ...
        !$OMP& FIRSTPRIVATE(ISEND_FIELD_COUNT_V,ISEND_WSET_SIZE_V,NPROMA,&
        !$OMP& ISEND_WSET_OFFSET_V,INS,ICOMBUFS_OFFSET_V) &
#ifndef __amdflang__

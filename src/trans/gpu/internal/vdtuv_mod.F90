...
REAL(KIND=JPRB), INTENT(INOUT) :: PVOR(KLD,R%NTMAX+3,D%NUMP),PDIV(KLD,R%NTMAX+3,D%NUMP)
REAL(KIND=JPRB), INTENT(OUT)   :: PU  (KLD,R%NTMAX+3,D%NUMP),PV  (KLD,R%NTMAX+3,D%NUMP)
